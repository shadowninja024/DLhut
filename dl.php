...
<body style="word-break: break-all;" class="bg-light">
  ...
  <div class="text-center">
    Paste a video url or name below and press "Download".<br><br>
    <form action="/sf.php" method="GET" class="mt-2">  <input required type="text" placeholder="Video URL or Name" class="mb-3" name="sdl"  value=""><br><br>  <button class="btn btn-success" type="submit">Download</button>
    </form>
   <div class="m-5">
<center>
